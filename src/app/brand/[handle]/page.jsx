...
export default function BrandProfilePage() {
        ...
        try {
            ...
            if (dbProfile) {
                ...
                if (matchedPost) {
                    ...
                    vendorPosts.forEach((vp) => {
                        // Use tagged products
                        if (vp.taggedProducts) {
                            vp.taggedProducts.forEach((tp) => {
    ...
    if (loading) {
        return (<main className={styles.loadingScreen}>
                <Navbar />
    ...
    return (<main className={styles.main}>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.coverSection}>
                    ...
                    {brand.avatar && (<Image src={brand.avatar} alt="" fill className={styles.coverImage} priority style={{ filter: 'blur(15px)' }}/>)}
                </div>
                ...
                <div className={styles.brandHeaderCard}>
                    <div className={styles.profileRow}>
                        <div className={styles.avatarContainer}>
                            {brand.avatar ? (<Image src={brand.avatar} alt={brand.name} fill className={styles.avatarImage}/>) : (<div className={styles.avatarFallback}>
                    ...
                    <div className={styles.actionsAndMetrics}>
                        ...
                        <div className={styles.buttonGroup}>
                            <button onClick={() => setFollowing(!following)} className={`${styles.primaryAction} ${following ? styles.primaryActionFollowing : ''}`}>
                                {following ? 'Following' : 'Follow Brand'}
                            </button>
                            <button onClick={() => alert(`📩 Chat initiated with ${brand.name}`)} className={styles.secondaryAction}>
