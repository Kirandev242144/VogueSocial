...
import { Cpu, RefreshCw, Clock, DollarSign, Layers, Play, Settings, Activity, Terminal, Zap } from 'lucide-react';
const INITIAL_JOBS = [
          ...
          <div className={styles.panel} style={{ padding: '1.5rem' }}>
            ...
            <div style={{ width: '100%', height: '240px', position: 'relative' }}>
              <svg className={styles.chartSvg} viewBox="0 0 1000 240" preserveAspectRatio="none">
                ...
                {/* Area Path */}
                <path className={styles.chartArea} d="M 0 190 L 150 160 L 300 205 L 450 120 L 600 135 L 750 80 L 900 105 L 1000 65 L 1000 220 L 0 220 Z" fill="url(#gpu-area-gradient)"/>

                {/* Line Path */}
                <path className={styles.chartPath} d="M 0 190 L 150 160 L 300 205 L 450 120 L 600 135 L 750 80 L 900 105 L 1000 65" fill="none" stroke="url(#gpu-line-gradient)" strokeWidth="3.5" strokeLinecap="round"/>
          ...
          <div className={styles.panel} style={{ border: '1px dashed var(--d-border)', background: 'var(--d-hover)' }}>
            ...
            <div style={{ padding: '1.25rem' }}>
              ...
              <div className={styles.fGroup}>
                ...
                <select className={styles.fSelect} value={simCategory} onChange={e => setSimCategory(e.target.value)}>
              ...
              <div style={{ display: 'flex', gap: '0.50rem', marginBottom: '0.75rem' }}>
                <button onClick={handleScaleUp} className={styles.actionBtnPrimary} style={{ flex: 1, padding: '0.65rem 0' }}>
                  Scale Container +
                </button>
                <button onClick={handleScaleDown} className={styles.actionBtn} style={{ flex: 1, padding: '0.65rem 0' }}>
                  Terminate Pod -
                </button>
              </div>

              <button onClick={handleTriggerSimJob} className={styles.btnPrimary} style={{
            width: '100%',
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: '1.5rem', alignItems: 'start' }}>
            ...
            <div style={{ padding: '1.5rem' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '1rem', marginBottom: '1.25rem' }}>
                <div className={styles.fGroup} style={{ marginBottom: 0 }}>
                  ...
                  <input type="text" className={styles.fInput} style={{ fontFamily: 'monospace', fontSize: '0.8rem' }} value={endpointId} onChange={e => setEndpointId(e.target.value)}/>
                </div>
                <div className={styles.fGroup} style={{ marginBottom: 0 }}>
              ...
              <div className={styles.fGroup}>
                ...
                <input type="text" className={styles.fInput} style={{ fontFamily: 'monospace', fontSize: '0.8rem' }} value={dockerImage} onChange={e => setDockerImage(e.target.value)}/>
              </div>
          ...
          <div className={styles.panel} style={{ border: '1px solid var(--d-border)' }}>
            ...
            <div style={{ padding: '0.85rem', background: '#020617', minHeight: '185px', borderRadius: '0 0 16px 16px', overflowY: 'auto', maxHeight: '185px' }}>
              {logs.map((log, index) => (<div key={index} className={styles.consoleLogLine}>
              ...
              {isSimulatingJob && (<div className={styles.consoleLogLine}>
