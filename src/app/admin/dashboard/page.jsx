...
import { DollarSign, ShieldCheck, Landmark, Users, ArrowUpRight, Package, TrendingUp } from 'lucide-react';
export default function AdminDashboardPage() {
    ...
    const getEscrowBadgeClass = (status) => {
        switch (status) {
    ...
    return (<>
      ...
      <div className={styles.pageContent}>
        ...
        <div className={styles.panel} style={{ marginBottom: '1.75rem', padding: '1.5rem' }}>
          ...
          <div style={{ width: '100%', height: '240px', position: 'relative' }}>
            <svg className={styles.chartSvg} viewBox="0 0 1000 240" preserveAspectRatio="none">
              ...
              <path className={styles.chartArea} d="M 0 210 L 140 180 L 280 195 L 420 130 L 560 145 L 700 90 L 840 115 L 1000 70 L 1000 220 L 0 220 Z" fill="url(#area-gradient)"/>

              {/* Line Path */}
              <path className={styles.chartPath} d="M 0 210 L 140 180 L 280 195 L 420 130 L 560 145 L 700 90 L 840 115 L 1000 70" fill="none" stroke="url(#line-gradient)" strokeWidth="3.5" strokeLinecap="round"/>
        ...
        <div className={styles.panel}>
          ...
          {loading ? (<div style={{ padding: '2rem', textAlign: 'center', color: 'var(--d-t3)' }}>Loading transactions...</div>) : (<table className={styles.table}>
              <thead>
                <tr>
                  <th>Order ID</th>
                  <th>Customer</th>
