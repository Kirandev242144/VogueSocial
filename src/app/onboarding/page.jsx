            ...
            <div className={styles.content}>
                ...
                {step === 1 && (<div className={styles.stepContainer}>
                        ...
                        <div className={styles.grid}>
                            {['Streetwear', 'Minimal', 'Luxury', 'Casual', 'Party', 'Office', 'Ethnic', 'Vintage', 'Athleisure', 'Trendy'].map((style) => (<div key={style} className={`${styles.card} ${selectedStyles.includes(style) ? styles.selected : ''}`} onClick={() => {
                ...
                {step === 2 && (<div className={styles.stepContainer}>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            <div className={styles.pillGroup}>
                                {['28', '30', '32', '34', '36', '38'].map(s => (<div key={s} className={`${styles.pill} ${sizes.bottom === s ? styles.activePill : ''}`} onClick={() => setSizes({ ...sizes, bottom: s })}>
                                        {s}
                                    </div>))}
                            </div>
                        </div>
