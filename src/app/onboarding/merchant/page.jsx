...
import { Store, Globe, Target, PenTool } from 'lucide-react';
export default function MerchantOnboardingPage() {
                ...
                cursor: 'pointer', transition: 'all 0.2s'
                    ...
                    <form onSubmit={authMode === 'login' ? handleLogin : handleRegister}>
                        <div className={styles.formGroup}>
                            ...
                            <input type="email" className={styles.input} placeholder="name@brand.com" value={email} onChange={e => setEmail(e.target.value)} required/>
                        </div>
                        ...
                        <button type="submit" className={styles.primaryBtn} disabled={authLoading} style={{ marginTop: '1rem' }}>
    ...
    return (<div className={styles.container}>
            ...
            <div className={styles.content}>
                {/* STEP 1: IDENTITY */}
                {step === 1 && (<div className={styles.stepContainer}>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            <input type="text" className={styles.input} placeholder="e.g. Urban Chic" value={formData.store_name} onChange={(e) => setFormData({ ...formData, store_name: e.target.value })}/>
                        </div>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            <div style={{ position: 'relative' }}>
                                ...
                                <input type="text" className={styles.input} style={{ paddingLeft: '2.2rem' }} placeholder="yourbrand" value={formData.store_handle} onChange={(e) => setFormData({ ...formData, store_handle: e.target.value.toLowerCase().replace(/\s+/g, '') })}/>
                            </div>
                        </div>

                        <button className={styles.primaryBtn} disabled={!formData.store_name || !formData.store_handle} onClick={handleNext}>
                            Continue
                        </button>
                    </div>)}

                {/* STEP 2: NICHE */}
                {step === 2 && (<div className={styles.stepContainer}>
                        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '1.5rem' }}>
                            <div style={{ background: 'var(--primary)', padding: '1.5rem', borderRadius: '50%', color: 'var(--primary-text)' }}>
                                <Target size={40}/>
                            </div>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            <div className={styles.pillGroup}>
                                {['Luxury', 'Streetwear', 'Casual', 'Ethnic', 'Vintage', 'Athleisure'].map(cat => (<div key={cat} className={`${styles.pill} ${formData.store_category === cat ? styles.activePill : ''}`} onClick={() => setFormData({ ...formData, store_category: cat })}>
                                        {cat}
                                    </div>))}
                            </div>
                        </div>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            <div className={styles.pillGroup}>
                                {['Men', 'Women', 'Unisex', 'Kids'].map(aud => (<div key={aud} className={`${styles.pill} ${formData.target_audience.includes(aud) ? styles.activePill : ''}`} onClick={() => {
                    ...
                    setFormData({ ...formData, target_audience: newAud });
                        ...
                        <button className={styles.primaryBtn} disabled={!formData.store_category || formData.target_audience.length === 0} onClick={handleNext}>
                            Continue
                        </button>
                    </div>)}

                {/* STEP 3: PRESENCE */}
                {step === 3 && (<div className={styles.stepContainer}>
                        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '1.5rem' }}>
                            <div style={{ background: 'var(--primary)', padding: '1.5rem', borderRadius: '50%', color: 'var(--primary-text)' }}>
                                <Globe size={40}/>
                            </div>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            <input type="url" className={styles.input} placeholder="https://yourstore.com" value={formData.website_url} onChange={(e) => setFormData({ ...formData, website_url: e.target.value })}/>
                        </div>

                        <div className={styles.formGroup}>
                            <label>Instagram Handle</label>
                            <input type="text" className={styles.input} placeholder="@yourbrand" value={formData.instagram_handle} onChange={(e) => setFormData({ ...formData, instagram_handle: e.target.value })}/>
                        </div>

                        <div className={styles.formGroup}>
                            <label>Location</label>
                            <input type="text" className={styles.input} placeholder="City, Country" value={formData.location} onChange={(e) => setFormData({ ...formData, location: e.target.value })}/>
                        </div>
                ...
                {/* STEP 4: STORY */}
                {step === 4 && (<div className={styles.stepContainer}>
                        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '1.5rem' }}>
                            <div style={{ background: 'var(--primary)', padding: '1.5rem', borderRadius: '50%', color: 'var(--primary-text)' }}>
                                <PenTool size={40}/>
                            </div>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            <textarea className={styles.textarea} placeholder="What makes your brand unique?" value={formData.store_description} onChange={(e) => setFormData({ ...formData, store_description: e.target.value })}/>
                        </div>
