"use client";
import { Sparkles, TrendingUp, ShoppingBag, Clock, ShieldCheck } from 'lucide-react';
...
const Hero = () => {
    ...
    return (<section className={styles.hero} ref={targetRef}>
            ...
            <div className={`container ${styles.container}`}>
                ...
                <div className={styles.mockupsContainer}>
                    ...
                    {/* Phone 1 */}
                    <motion.div className={`${styles.phoneMockup} ${styles.phoneLeft}`} animate={{
            y: [40, 60, 40],
            rotateY: [15, 12, 15]
        }} transition={{
            duration: 6,
            ...
            ease: "easeInOut"
                    ...
                    {/* Phone 3 */}
                    <motion.div className={`${styles.phoneMockup} ${styles.phoneRight}`} animate={{
            y: [40, 20, 40],
            rotateY: [-15, -12, -15]
        }} transition={{
            duration: 7,
